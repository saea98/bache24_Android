...
public class ResideMenu extends FrameLayout {
    ...
    public ResideMenu(Context context, int windowHeight) {
        super(context);
    ...
    private void initViews(Context context, int customLeftMenuId,
        ...
        if (customLeftMenuId >= 0) {
            ...
            mLayoutMenuContainer = (RelativeLayout) scrollViewLeftMenu.findViewById(R.id.layout_menu_container);
            versionTextView = (TextView) scrollViewLeftMenu.findViewById(R.id.textView);
        }
        ...
        if (mLayoutMenuContainer != null) {
            RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                                                                                ViewGroup.LayoutParams.MATCH_PARENT);
//            params.setMargins(0, 50, 0, 50);
//            int screenHeight = getScreenHeight();
            params.setMargins(0, (int)(windowHeight * 0.15), 0, (int)(windowHeight * 0.15));


            mLayoutMenuContainer.setLayoutParams(params);
        }
    ...
    public void setShadowVisible(boolean isVisible) {
        if (isVisible)
            imageViewShadow.setBackgroundResource(R.drawable.sombra_menu); //R.drawable.shadow);
        else
...
//                mScaleValue + shadowAdjustScaleX, mScaleValue + shadowAdjustScaleY);
    ...
    public void closeMenu() {
        ...
        AnimatorSet alpha_menu = buildMenuAnimation2(scrollViewMenu, 0.0f);
    ...
    private AnimatorSet buildMenuAnimation2(View target, float alpha) {
